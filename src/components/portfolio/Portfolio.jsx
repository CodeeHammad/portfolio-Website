...
const  data = [
  ...
  id: 4,
  image:  IMG4,
  title: 'Maintainig tasks and tracking progress',
  github: 'https://github.com',
  ...
  title: 'Charts templates & infographics in Figma',
  github: 'https://github.com',
  demo: 'https://dribble.com/shots16541289-Orion-UI-kit-charts-templates'
},
  {
  id: 6,
  image:  IMG6,
...
const Portfolio = () => {
  return (
    <section id='portfolio'>
      ...
      {
        return(
          <artcile key={id} className="portfolio__item">
